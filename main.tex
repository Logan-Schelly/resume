...
\smallskip
\hrule
I have 2 years of experience in administration and research at a proprietary trading firm.
I graduated in 2020 with a degree in applied math and a minor in computer science,
and I paid for school by tutoring in the campus math lab.
I'm looking to start the next chapter in my career.

\textbf{Work Experience}
\smallskip
\hrule

\jobInfo{Executive Assistant and Quantitative Researcher}{Alamo, CA}{Tanius Technology LLC}{Aug 2020 -- Aug 2022}
\begin{compactItemize}
  \item Payroll, 401(k), compliance, and other administrative tasks for a company of 35 people.
  \item Data visualization for both derivative traders and real estate fix-and-flips.
  \item Used SSIS, condor, and C\# to parallelize a pre-trade market events data pipeline.
  \item Debugging of a live recordkeeping and pricing application.
  \item Billing, bookkeeping, and banking for the owner's household and other corporations.
\end{compactItemize}
...
\hrule
  ...
  $\bullet$ Hiking
  $\bullet$ Biking
  $\bullet$ Church Hopping
  $\bullet$ Scenic Routes
  $\bullet$ Catching Up with Old Friends
  \end{center}
